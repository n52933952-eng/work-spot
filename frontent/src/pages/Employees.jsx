...
const Employees = () => {
  ...
  const handleEmployeeApproved = useCallback((data) => {
    ...
    toast({
      title: 'موظف جديد',
      description: 'تم الموافقة على موظف جديد',
      status: 'info',
      duration: 3000,
      isClosable: true,
    });
  ...
  const handleUpdateEmployee = async () => {
    ...
    try {
      ...
      toast({
        title: 'خطأ',
        description: error.message || 'فشل تحديث معلومات الموظف',
        status: 'error',
        duration: 5000,
        isClosable: true,
      });
    ...
    <MainLayout>
      <Box w="100%" maxW="100%" overflowX="hidden" boxSizing="border-box">
        ...
        >
          <VStack align="start" spacing={1} flex={{ base: "1 1 100%", md: "0 1 auto" }}>
            ...
            <Text 
              ...
              color="gray.500"
            >
              إدارة وتعديل معلومات الموظفين وتحديث الأدوار والمناصب
            </Text>
          </VStack>
          <IconButton
            icon={<FiRefreshCw />}
        ...
        <Modal isOpen={isEditOpen} onClose={onEditClose} size="lg">
          <ModalOverlay />
          <ModalContent>
            <ModalHeader>تعديل معلومات الموظف</ModalHeader>
            <ModalCloseButton />
            <ModalBody>
              {selectedEmployee && (
                <VStack spacing={4} align="stretch">
                  ...
                  <FormControl>
                    ...
                    <Input
                      ...
                      placeholder="مثال: مدير المبيعات، مبرمج، محلل"
                    />
                  </FormControl>
